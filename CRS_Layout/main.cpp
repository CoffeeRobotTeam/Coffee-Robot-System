...
CoffeeKinds mycoffeekind = kind1;//默认咖啡种类1
Coffee mycoffee(mycup, myaddmaterial, mycoffeekind);
 int main(){
	...
	JointFrame prejointframe, nowjointframe;
  //  myRobot.RobotShow();
 	//myRobot.PTPMove(WF,P2);
 	//myRobot.RobotShow();
 	//myRobot.PTPMove(TF1,P3);
 	//myRobot.RobotShow();
	prejointframe = myRobot.getjointframe();
 	myRobot.PTPMove(TF2,P4);
 	myRobot.RobotShow();
	nowjointframe = myRobot.getjointframe();
	JointDisplay(prejointframe, nowjointframe);
